...
class BayesianFlow(nn.Module, ABC):
    ...
    @abstractmethod
    def get_prior_input_params(self, data_shape: tuple, device: torch.device):
    ...
    @abstractmethod
    def params_to_net_inputs(self, params) -> Tensor:
    ...
    @abstractmethod
    def update_input_params(self, input_params, y: Tensor, alpha: float):
    ...
    @abstractmethod
    def forward(self, data: Tensor, t: Tensor):
